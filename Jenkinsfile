        ...
        stage ('Deploy') {   
            ...
            steps {               
                script{                   
                    ...
                    sh "/home/coding-muse/.local/bin/ansible-playbook playbook.yml --extra-vars \"image_id=${image_id} ansible_become_pass=${BECOME_PASSWORD} ansible_become_user=coding-muse\""            
                }           
            }       
        }   
    }
